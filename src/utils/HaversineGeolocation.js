class HaversineGeolocation {
   ...
   * @returns {*}
   */
  static _convertMeasurements(distance, measurement = 'km') {
    let res = null;
   ...
   * @returns {number}
   */
  static getDistanceBetween(p1, p2, measurement) {
   ...
   * @returns {{}}
   */
  static getClosestPosition(current, otherPoints, measurement) {
    let distance = null;
    let data = {};
...
module.exports = HaversineGeolocation;
